...
import { Layout02Icon, CheckmarkCircle01Icon } from '@hugeicons/core-free-icons';
        ...
        <Card className="border-cyan-200 bg-cyan-50">
            <CardHeader>
                <CardTitle className="flex items-center gap-2 text-cyan-900">
                    <HugeiconsIcon icon={Layout02Icon} size={20} />
                    Spacing System
                </CardTitle>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-cyan-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">px-4 py-2</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">p-6</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">px-3 py-2</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">px-2 py-0.5</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">px-4 py-3</code>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-cyan-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">space-y-8 (32px)</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">gap-6 (24px)</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">space-y-4 (16px)</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">gap-2 (8px)</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">space-y-3 (12px)</code>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-cyan-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">px-6 (24px)</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">px-4 (16px)</code>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-cyan-50 rounded border border-cyan-200">
                            <div>
                            ...
                            <code className="text-xs text-cyan-700 bg-white px-2 py-1 rounded">py-6 (24px)</code>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-cyan-200 p-4">
                    ...
                    <div className="space-y-2">
                        {[
                            ...
                            <div key={item.value} className="flex items-center gap-3 p-2 bg-cyan-50 rounded">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2">
                                        <code className="text-xs text-cyan-700 font-semibold">{item.value}</code>
                ...
                <Alert className="border-cyan-300 bg-cyan-100">
                    <HugeiconsIcon icon={CheckmarkCircle01Icon} size={16} className="text-cyan-700" />
