...
export function WorkOrderDataTable({ workOrders, technicians, locations, customers, vehicles, onEdit, onDelete, onUpdateWorkOrder, onViewDetails }: WorkOrderDataTableProps) {
  ...
  }, [workOrders, technicians, locations, customers, vehicles]);
