                ...
                <div className="bg-white rounded-lg border border-teal-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="border-l-4 border-teal-600 pl-4">
                            ...
                            <code className="text-xs text-foreground">text-2xl (24px) • font-bold • text-gray-900</code>
                ...
                <div className="bg-white rounded-lg border border-teal-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="border-l-4 border-teal-500 pl-4">
                            ...
                            <code className="text-xs text-foreground">text-lg (18px) • font-semibold • text-gray-900</code>
                ...
                <div className="bg-white rounded-lg border border-teal-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="border-l-4 border-teal-400 pl-4">
                            ...
                            <code className="text-xs text-foreground">text-base (16px) • font-medium • text-gray-900</code>
                ...
                <div className="bg-white rounded-lg border border-teal-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="border-l-4 border-gray-400 pl-4">
                            ...
                            <code className="text-xs text-foreground">text-sm (14px) • font-normal • text-gray-700</code>
                ...
                <div className="bg-white rounded-lg border border-teal-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="border-l-4 border-gray-500 pl-4">
                            ...
                            <code className="text-xs text-foreground">text-sm (14px) • font-medium • text-gray-700</code>
                ...
                <div className="bg-white rounded-lg border border-teal-200 p-4">
                    ...
                    <div className="space-y-3">
                        <div className="border-l-4 border-gray-300 pl-4">
                            ...
                            <code className="text-xs text-foreground">text-xs (12px) • font-normal • text-gray-500</code>
                ...
                <div className="bg-white rounded-lg border border-teal-200 p-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            ...
                            <code className="text-xs text-foreground">text-gray-900</code>
                        </div>
                        <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            <span className="text-sm text-gray-700">Secondary Text</span>
                            <code className="text-xs text-foreground">text-gray-700</code>
                        </div>
                        <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            <span className="text-sm text-gray-600">Tertiary Text</span>
                            <code className="text-xs text-foreground">text-gray-600</code>
                        </div>
                        <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            <span className="text-sm text-gray-500">Muted Text</span>
                            <code className="text-xs text-foreground">text-gray-500</code>
                        </div>
                        <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            <span className="text-sm text-gray-400">Disabled Text</span>
                            <code className="text-xs text-foreground">text-gray-400</code>
                        </div>
                    </div>
                </div>

                <Alert className="border-teal-300 bg-muted">
