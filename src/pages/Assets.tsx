      ...
      <div className="w-80 flex-none border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex flex-col">
        ...
        <div className="border-b border-gray-200 dark:border-gray-800">
          ...
          <div className="p-4 pb-4">
            <h1 className="text-lg font-bold font-brand text-gray-900 dark:text-gray-100">Assets</h1>
          </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-sm font-bold font-data text-gray-900 dark:text-gray-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-gray-950">
        {selectedAsset ? (
          <div className="flex flex-col h-full">
            <div className="flex-none p-6 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 z-10">
                ...
                return (
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-3">
                          <h2 className="text-xl font-bold font-data text-gray-900 dark:text-gray-100">
                      ...
                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-3">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xl font-bold font-data text-gray-900 dark:text-gray-100 mt-0.5">{assetWorkOrders.length}</p>
                          </div>
                      ...
                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-3">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xl font-bold font-data text-gray-900 dark:text-gray-100 mt-0.5">{openWorkOrders}</p>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="mt-1">
                              {(() => {
                                ...
                                return (
                                  <p className="text-xl font-bold font-data text-gray-900 dark:text-gray-100">
                      ...
                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-3">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xl font-bold font-data text-gray-900 dark:text-gray-100 mt-0.5">
                ...
                <div>
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg divide-y divide-gray-100 dark:divide-gray-800">
                    <div className="p-3">
                      ...
                      <p className="text-sm text-gray-900 dark:text-gray-100 mt-1 font-bold font-data">{selectedAsset.license_plate || 'Not specified'}</p>
                    </div>
                    <div className="p-3">
                          ...
                          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                            {assetWorkOrders.slice(0, 10).map((workOrder) => {
                              ...
                              return (
                                ...
                                >
                                  <td className="px-4 py-3 font-bold font-data text-gray-900 dark:text-gray-100">
