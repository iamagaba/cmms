...
const CommonCMMSPatternsSection: React.FC = () => {
    return (
        <Card className="border-emerald-200 bg-muted">
            <CardHeader>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-emerald-200 p-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-muted p-3 rounded border border-emerald-200">
                            <Dialog>
                ...
                <div className="bg-white rounded-lg border border-emerald-200 p-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-muted p-3 rounded border border-emerald-200 space-y-3">
                            <div>
