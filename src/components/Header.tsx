    ...
    <Header style={{ padding: '0 24px', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #f0f0f0' }}>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', marginRight: '24px' }}>
          <FireOutlined style={{color: '#7F56D9', fontSize: '24px'}} /> {/* GOGO Brand Purple - Toned down */}
          <span style={{color: '#7F56D9', marginLeft: '8px', fontWeight: 'bold', fontSize: '18px'}}>GOGO Electric</span> {/* GOGO Brand Purple - Toned down */}
        </div>
