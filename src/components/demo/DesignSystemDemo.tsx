    ...
    <div className="max-w-7xl mx-auto space-y-8">
              ...
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:palette" className="w-3.5 h-3.5 text-gray-500" />
            ...
            <section id="components" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:layout" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Panel Component
                    </h2>
                  </div>
  ...
  <PanelFooter>Footer Content</PanelFooter>
            ...
            <section id="inputs" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:forms" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Form Elements
                    </h2>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <Input 
                          ...
                          type="email"
                          rightIcon={<Icon icon="tabler:mail" className="w-3.5 h-3.5 text-gray-400" />}
                        />
                      </div>
                    </div>
...
<input type="radio" className="w-4 h-4 border-gray-300 text-purple-600" />`}
            ...
            <section id="badges" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:tag" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Badge Components
                    </h2>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-purple-50 border border-purple-200 rounded-md p-4">
                      <div className="flex gap-2">
                        <Icon icon="tabler:info-circle" className="w-4 h-4 text-purple-600 flex-shrink-0 mt-0.5" />
                        <div>
...
/>`}
            ...
            <section id="utilities" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:tool" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      CSS Utility Classes
                    </h2>
                  </div>
                      ...
                      <div className="stat-card">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="w-12 h-12 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center">
                            <Icon icon="tabler:clipboard-list" className="w-6 h-6" />
                          </div>
                        </div>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-md border border-gray-200 mt-3">
  ...
  {/* Metric content */}
            ...
            <section id="stat-ribbon" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:chart-bar" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Stat Ribbon Pattern
                    </h2>
                  </div>
                ...
                <PanelContent>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="info-bar">
                        <div className="info-bar-item">
                          <Icon icon="tabler:clipboard-list" className="w-3.5 h-3.5 text-blue-600" />
                          <span className="text-gray-500">Work Orders:</span>
                          <span className="font-semibold text-gray-900">24</span>
                        </div>
                        <div className="info-bar-divider" />
                        <div className="info-bar-item">
                          <Icon icon="tabler:circle-check" className="w-3.5 h-3.5 text-emerald-600" />
                          <span className="text-gray-500">Completed:</span>
                          <span className="font-semibold text-emerald-700">18</span>
                        </div>
                        <div className="info-bar-divider" />
                        <div className="info-bar-item">
                          <Icon icon="tabler:clock" className="w-3.5 h-3.5 text-orange-600" />
                          <span className="text-gray-500">In Progress:</span>
                          <span className="font-semibold text-orange-700">4</span>
                        </div>
                        <div className="info-bar-divider" />
                        <div className="info-bar-item">
                          <Icon icon="tabler:alert-triangle" className="w-3.5 h-3.5 text-red-600" />
  ...
  <div className="info-bar-item">
    ...
    <span className="font-semibold text-emerald-700">6</span>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                      <div className="flex gap-2">
                        <Icon icon="tabler:lightbulb" className="w-4 h-4 text-blue-600 flex-shrink-0 mt-0.5" />
                        <div>
            ...
            <section id="typography" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:typography" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Typography Scale
                    </h2>
                  </div>
            ...
            <section id="buttons" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:click" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Button Components
                    </h2>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        <button className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 rounded-md transition-colors" disabled>
                          <Icon icon="tabler:loader" className="w-4 h-4 animate-spin" />
                          Loading...
                        </button>
                      </div>
                    </div>
  ...
  Cancel
            ...
            <section id="data-table" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:table" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Data Table
                    </h2>
                  </div>
      ...
      <td className="px-4 py-3 text-sm text-gray-600">Cell Content</td>
            ...
            <section id="notification-badges" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:bell" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Notification Badges
                    </h2>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        <div className="relative inline-flex">
                          <button className="inline-flex items-center justify-center w-10 h-10 text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 rounded-md transition-colors">
                            <Icon icon="tabler:message" className="w-5 h-5" />
                          </button>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <Icon icon="tabler:inbox" className="w-4 h-4 text-gray-600" />
                        ...
                        <div className="flex items-center gap-2">
                          <Icon icon="tabler:star" className="w-4 h-4 text-gray-600" />
                        ...
                        <div className="flex items-center gap-2">
                          <Icon icon="tabler:archive" className="w-4 h-4 text-gray-600" />
...
<span className="absolute top-1 right-1 w-2.5 h-2.5 bg-red-600 rounded-full border-2 border-white"></span>`}
            ...
            <section id="icons" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:icons" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                ...
                <PanelContent>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                          <Icon icon="tabler:home" className="w-3 h-3 text-gray-600" />
                          <div>
                        ...
                        <div className="flex items-center gap-4">
                          <Icon icon="tabler:home" className="w-3.5 h-3.5 text-gray-600" />
                          <div>
                        ...
                        <div className="flex items-center gap-4">
                          <Icon icon="tabler:home" className="w-4 h-4 text-gray-600" />
                          <div>
                        ...
                        <div className="flex items-center gap-4">
                          <Icon icon="tabler:home" className="w-5 h-5 text-gray-600" />
                          <div>
                        ...
                        <div className="flex items-center gap-4">
                          <Icon icon="tabler:home" className="w-6 h-6 text-gray-600" />
                          <div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-4 gap-4">
                        {[
                          ...
                          { icon: 'tabler:clipboard-list', label: 'Work Orders' },
                          { icon: 'tabler:package', label: 'Assets' },
                          { icon: 'tabler:users', label: 'Technicians' },
                          { icon: 'tabler:search', label: 'Search' },
                          { icon: 'tabler:settings', label: 'Settings' },
                          { icon: 'tabler:calendar', label: 'Calendar' },
                          { icon: 'tabler:chart-line', label: 'Reports' },
                          { icon: 'tabler:bell', label: 'Notifications' },
                          { icon: 'tabler:user', label: 'User' },
                          { icon: 'tabler:check', label: 'Check' },
                          { icon: 'tabler:x', label: 'Close' },
                        ].map((item) => (
                          <div key={item.icon} className="flex flex-col items-center gap-2 p-3 border border-gray-200 rounded-md hover:border-purple-300 hover:bg-purple-50 transition-colors">
                            <Icon icon={item.icon} className="w-6 h-6 text-gray-600" />
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                      <div className="flex gap-2">
                        <Icon icon="tabler:info-circle" className="w-4 h-4 text-blue-600 flex-shrink-0 mt-0.5" />
                        <div>
                          <p className="text-sm font-medium text-blue-900 mb-1">Icon Library</p>
                          <p className="text-xs text-blue-700">
                            We use Tabler Icons via @iconify/react. Browse all icons at{' '}
                            <a href="https://tabler-icons.io" target="_blank" rel="noopener noreferrer" className="underline">
                              tabler-icons.io
                            </a>
                          </p>
                        </div>
            ...
            <section id="loading" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:loader" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Loading States
                    </h2>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-6">
                        <div className="text-center">
                          <Icon icon="tabler:loader" className="w-6 h-6 text-purple-600 animate-spin mx-auto mb-2" />
                          <p className="text-xs text-gray-500">Small (24px)</p>
                        </div>
                        <div className="text-center">
                          <Icon icon="tabler:loader" className="w-8 h-8 text-purple-600 animate-spin mx-auto mb-2" />
                          <p className="text-xs text-gray-500">Medium (32px)</p>
                        </div>
                        <div className="text-center">
                          <Icon icon="tabler:loader" className="w-12 h-12 text-purple-600 animate-spin mx-auto mb-2" />
                    ...
                    <div>
                      ...
                      <div className="border border-gray-200 rounded-lg p-8 bg-gray-50">
                        <div className="flex flex-col items-center justify-center">
                          <Icon icon="tabler:loader" className="w-12 h-12 text-purple-600 animate-spin mb-4" />
                    ...
                    <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                      <pre className="text-xs text-gray-700 overflow-x-auto">
{`// Spinner
<Icon icon="tabler:loader" className="w-6 h-6 text-purple-600 animate-spin" />
...
// Loading State
{isLoading ? (
  <Icon icon="tabler:loader" className="w-6 h-6 animate-spin" />
) : (
  <Content />
)}`}
                      </pre>
            ...
            <section id="alerts" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:alert-circle" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Alerts & Messages
                    </h2>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                      <div className="flex gap-3">
                        <Icon icon="tabler:info-circle" className="w-5 h-5 text-blue-600 flex-shrink-0" />
                        <div>
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 rounded-md p-4">
                      <div className="flex gap-3">
                        <Icon icon="tabler:circle-check" className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                        <div>
                    ...
                    <div className="bg-orange-50 border border-orange-200 rounded-md p-4">
                      <div className="flex gap-3">
                        <Icon icon="tabler:alert-triangle" className="w-5 h-5 text-orange-600 flex-shrink-0" />
                        <div>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-md p-4">
                      <div className="flex gap-3">
                        <Icon icon="tabler:alert-circle" className="w-5 h-5 text-red-600 flex-shrink-0" />
                        <div>
                    ...
                    <div className="bg-purple-50 border border-purple-200 rounded-md p-4">
                      <div className="flex gap-3">
                        <Icon icon="tabler:sparkles" className="w-5 h-5 text-purple-600 flex-shrink-0" />
...
<div className="bg-blue-50 border border-blue-200 rounded-md p-4">
  <div className="flex gap-3">
    <Icon icon="tabler:info-circle" className="w-5 h-5 text-blue-600" />
    <div>
      ...
      <p className="text-xs text-blue-700">Message</p>
            ...
            <section id="spacing" className="scroll-mt-6">
              <Panel>
                <PanelHeader>
                  <div className="flex items-center gap-2">
                    <Icon icon="tabler:ruler" className="w-3.5 h-3.5 text-gray-500" />
                    <h2 className="text-xs font-semibold text-gray-900 uppercase tracking-wide">
                      Spacing System
                    </h2>
                  </div>
